...
/// SpendSense - Claude AI Provider implementation.
class ClaudeProvider implements AiProvider {
  ...
  Future<MyTransaction?> categorise(
    ...
    debugPrint('SpendSense AI: Categorising SMS with Claude...');
    ...
    try {
      ...
      if (response.statusCode != 200) {
        debugPrint(
            'SpendSense AI Error: Claude HTTP ${response.statusCode} - ${response.body}');
        return null;
      }
      ...
      debugPrint(
          'SpendSense AI: Claude successfully categorised as ${parsedJson['category']}.');

      return MyTransaction.fromClaudeResponse(parsedJson, smsText);
    } catch (e) {
      debugPrint('SpendSense AI Exception (Claude): $e');
      return null;
    }
  }
