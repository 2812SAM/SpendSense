...
void main() {
  ...
  setUp(() {
    ...
    when(() => mockLocal.markSyncFailed(any(), any()))
        .thenAnswer((_) async => {});
    ...
    when(() => mockLocal.findByFingerprint(any()))
  ...
  test('confirmCategory should update local storage and trigger sync',
      () async {
    ...
    verify(() => mockLocal.markConfirmed(tx.id,
        category: 'Food', type: AppConstants.typeExpense, note: '')).called(1);
